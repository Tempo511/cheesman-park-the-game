...
export const ARCHETYPES = {
  ...
  pothead: { id:'pothead', name:'🌿 Pothead',
    flavor:'Unbothered. Regenerates, and the supernatural doesn’t faze him.',
...
export const ARCHETYPE_ORDER = ['volleyball', 'tech', 'pothead'];
