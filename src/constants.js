...
export const ARCHETYPES = {
  ...
  tech: { id:'tech', name:'💻 Tech Bro', nameF:'💻 Tech Gal',
    ...
    ability1:{ name:'Overclock', icon:'⚡', level:5, cd:11, dur:5, speed:1.2, haste:1.6 },
    ability2:{ name:'Drone', icon:'✈', level:8, cd:24, dur:12, rate:0.35, dmg:10 } },
  hippie: { id:'hippie', name:'🌼 Hippie',
    ...
    ability1:{ name:'Second Wind', icon:'✦', level:5, cd:11, healFrac:0.4, dur:4, resist:0.4 },
    ability2:{ name:'Smoke Cloud', icon:'☁', level:8, cd:20, dur:7.5, radius:76, slow:0.35 } },
  jogger: { id:'jogger', name:'🏃 Jogger',
    ...
    ability1:{ name:'Sprint', icon:'⇢', level:5, cd:8, dur:2.2, speed:1.8 },
    ability2:{ name:'Bolder Boulder', icon:'∞', level:8, cd:20, dur:6, speed:1.5, dmg:18, knock:230 } },
  yogi: { id:'yogi', name:'🧘 Yogi',
    ...
    ability1:{ name:'Flow Roll', icon:'↻', level:5, cd:5, rollSpd:380, rollTime:0.22 },
    ability2:{ name:'Zen Mode', icon:'☯', level:8, cd:22, dur:5, slow:0.3, regen:9 } },
};
